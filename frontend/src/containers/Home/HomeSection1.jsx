...
import { donut, donutCrescent, landingImg } from "../../assets/img";
      ...
      <div className="relative z-0 max-w-[900px] w-full h-full bg-white flex flex-col md:flex-row items-center md:justify-between">
        ...
        >
          <motion.h1
            ...
            variants={item}
          >
            Feel Good <br /> Hospitality
          </motion.h1>
          <motion.p className="" variants={item}>
            The ambience, the service, the rooms, the menu - these are all part
            of the design. But to us, true hospitality is about putting people
            first. It's about thoughtful gestures that leave an impression.
          </motion.p>
        </motion.div>
