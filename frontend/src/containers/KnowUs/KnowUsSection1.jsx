...
import { donut, donutCrescent, spacesSection1 } from "../../assets/img";
        ...
        <div className="relative z-0 max-w-[900px] w-full h-full bg-white flex flex-col md:flex-row items-center md:justify-between">
          ...
          >
            ...
            <motion.p className="" variants={item}>
              A pillar of consistency and quality service, 17 Degrees has been
              setting the bar for competition since 2004 in Dhanbad.
            </motion.p>
          </motion.div>
